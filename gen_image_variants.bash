...
convert "imagery/conclusion.JPG" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 \
...
convert "imagery/intro.JPG" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 \
...
convert "imagery/raga.JPG" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 \
...
convert "imagery/sakkayaditthi.JPG" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 \
...
convert "imagery/samadhi.JPG" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 \
...
convert "imagery/samatha-vipassana.JPG" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 \
...
convert "imagery/sammaditthi.JPG" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 \
...
convert "imagery/sankhara.JPG" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 \
...
convert "imagery/sukha.JPG" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 \
...
convert "imagery/sunyata.JPG" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 \
...
convert "imagery/tanha.JPG" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 \
...
convert "imagery/thinamiddha.JPG" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 \
...
convert "imagery/uddhaccakukkuca.JPG" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 \
...
convert "imagery/upadana.JPG" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 \
...
convert "imagery/upekkha.JPG" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 \
...
convert "imagery/vedana.JPG" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 \
...
convert "imagery/vedananupassana.JPG" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 \
...
convert "imagery/vicikiccha.JPG" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 \
...
convert "imagery/vimutti.JPG" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 \
...
convert "imagery/vipassana.JPG" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 \
...
convert "imagery/vitakka.JPG" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 \
...
convert "imagery/viveka.JPG" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 \
...
convert "imagery/vossagga.JPG" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 \
...
convert "imagery/vyapada.JPG" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 \
...
convert "imagery/yathabhutanyanadassana.JPG" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 \
...
convert "imagery/yonisomanasikara.JPG" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 \
...
convert "buddhism/Qing_Manjusri_Bodhisattva.jpg" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 \
...
convert "buddhism/delhi_walking_monk.jpg" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 \
...
convert "buddhism/yellow_hats_at_a_Kyoto_temple.jpg" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 \
...
convert "buddhism/Amaravati_Autumn.jpg" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 \
...
convert "buddhism/tibetan_lessons.jpg" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 \
...
convert "buddhism/Yuttadhammo.jpeg" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 \
...
convert "buddhism/yama_samsara_wheel-wellcome.jpg" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 \
...
convert "buddhism/lotus_father.jpg" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 \
...
convert "buddhism/curiosity.jpg" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 \
...
convert "buddhism/Bodhgaya_path.jpg" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 \
...
convert "buddhism/Silver_buddha_inside_Jing'an_Temple,_Shanghai.png" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 \
...
convert "buddhism/fancy_buddha_back.jpg" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 \
...
convert "buddhism/monk_at_galle_fort_sl_oceanside.jpg" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 \
...
convert "buddhism/Wat_Khung_Taphao_novice.jpg" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 \
...
convert "buddhism/sitting_on_my_meditation_rock.jpg" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 \
...
convert "function/pakhao.jpg" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 \
...
convert "function/Bheemunipatnam_Beach.jpg" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 \
...
convert "function/lotus.jpg" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 \
...
convert "function/Kamakura_Shakyamuni_at_Cleveland_Museum_of_Art.jpg" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 \
...
convert "function/DP231900.jpg" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 \
...
convert "function/Bhamo.jpg" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 \
...
convert "function/tibetan_novices_relaxing.jpg" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 \
...
convert "function/Tsongmo_Lake_Sikkim.jpeg" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 \
...
convert "function/Chion-in.jpg" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 \
...
convert "function/Somchai_Jerapunyo.jpg" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 \
...
convert "function/Kodo_Sawaki_Zazen.jpg" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 \
...
convert "function/5160dt.jpg" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 \
...
convert "function/Albuquerque_winter_meditation.jpg" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 \
...
convert "function/burmese-layman-meditates-by-bell.jpg" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 \
...
convert "function/stupas.jpg" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 \
...
convert "Wooden_gate_with_open_double_door_leading_to_the_garden_of_Isshinin_Buddhist_temple_in_the_compounds_of_Chion-in_Kyoto_Japan.jpg" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 -write mpr:orig \
...
convert "The_Victory_of_Buddha_-_Myths_of_the_Hindus_&_Buddhists.jpg" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 -write mpr:orig \
...
pid=$!
convert "Bolpur_Gautam_Buddha_Statue.jpg" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 -write mpr:orig \
...
wait $pid
cat .out
convert "Mihinthalaya_Buddha_Statue.jpg" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 -write mpr:orig \
...
pid=$!
convert "DP123360.jpg" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 -write mpr:orig \
...
wait $pid
cat .out
convert "044_Teaching_the_Five_Disciples_(9014362720).jpg" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 -write mpr:orig \
...
pid=$!
convert "WHEN_I_HAVE_CAMERA_IN_MY_HAND,_I_KNOW_NO_RULES.jpg" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 -write mpr:orig \
...
wait $pid
cat .out
convert "Odilon_Redon_-_Buddha_-_Google_Art_Project.jpg" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 -write mpr:orig \
...
pid=$!
convert "Adachi_Museum_of_Art_Near_Matsue_Japanese_Garden_1.JPG" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 -write mpr:orig \
...
wait $pid
cat .out
convert "Illustrated_Sinhalese_covers_(inside)_showing_the_events_Wellcome_L0031774.jpg" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 -write mpr:orig \
...
pid=$!
convert "Baisigou_Square_Pagoda_Chinese_Buddhist_sutra_B.jpg" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 -write mpr:orig \
...
wait $pid
cat .out
convert "dipankara-sumedha.jpg" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 -write mpr:orig \
...
pid=$!
convert "016_Buddha_Teaching_(9170019757).jpg" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 -write mpr:orig \
...
wait $pid
cat .out
convert "Pearl_of_Searching.jpg" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 -write mpr:orig \
...
pid=$!
convert "Ajanta_Cave_17,_antechamber_to_the_shrine,_Adoration_of_the_Buddha_(color_illustration).jpg" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 -write mpr:orig \
...
wait $pid
cat .out
convert "Nonne_Kung_Fu_(Angkor_Vat)_(6926636097).jpg" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 -write mpr:orig \
...
pid=$!
convert "Lotus_in_a_Pond.jpg" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 -write mpr:orig \
...
wait $pid
cat .out
convert "Buddha,_resisting_the_demons_of_Mara,_Wellcome_V0046085.jpg" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 -write mpr:orig \
...
pid=$!
convert "China-Schanghai-Jade_Buddha-Temple-5176573.jpg" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 -write mpr:orig \
...
wait $pid
cat .out
convert "Wen_boren,_villaggio_acquatico,_1570,_01.jpg" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 -write mpr:orig \
...
pid=$!
convert "Buddha_in_Nirvana_(Death_of_Sakyamuni),_Kamakura_period,_13th_century,_wood_-_Tokyo_National_Museum_-_DSC05096.jpg" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 -write mpr:orig \
...
wait $pid
cat .out
convert "The_meditating_monk.jpg" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 -write mpr:orig \
...
pid=$!
convert "P5290155_(14971680537).jpg" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 -write mpr:orig \
...
wait $pid
cat .out
convert "Nanzen-ji,_a_Zen_Buddhist_temple,_and_its_surroundings,_Kyoto;_November_2016_(05).jpg" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 -write mpr:orig \
...
pid=$!
convert "Buddha_Temple_,_Bodhgaya.jpg" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 -write mpr:orig \
...
wait $pid
cat .out
convert "(Left)_The_predictions_of_the_brahmins,_Wellcome_L0030766.jpg" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 -write mpr:orig \
...
pid=$!
convert "Portrait_of_a_monk-MGR_Lyon-IMG_9873-black.jpg" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 -write mpr:orig \
...
wait $pid
cat .out
convert "Shuttle_Enterprise_Flight_to_New_York_(201204270023HQ).jpg" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 -write mpr:orig \
...
pid=$!
convert "Polonnaruwa.JPG" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 -write mpr:orig \
...
wait $pid
cat .out
convert "Monks_in_Wat_Phra_Singh_-_Chiang_Mai.jpg" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 -write mpr:orig \
...
pid=$!
convert "Buddhist_mala_beads_in_nun's_hand.jpg" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 -write mpr:orig \
...
wait $pid
cat .out
convert "Mihintale_Shirine.jpg" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 -write mpr:orig \
...
pid=$!
convert "BUDDHA-OIL_PAINTING.jpg" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 -write mpr:orig \
...
wait $pid
cat .out
convert "Chinese_Buddhist_Monk_Electric_Bike.jpeg" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 -write mpr:orig \
...
pid=$!
convert "Ascetic_Bodhisatta_Gotama_with_the_Group_of_Five.jpg" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 -write mpr:orig \
...
wait $pid
cat .out
convert "Charming_Swan_In_The_Mist_Of_Paradise_At_Nagarjuna_Sagar_Dam.jpg" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 -write mpr:orig \
...
pid=$!
convert "Dhamekh_Stupa,_where_the_Buddha_gave_the_first_sermon_on_the_Four_Noble_Truths_and_the_Eightfold_Path_to_his_five_disciples,_Sarnath.jpg" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 -write mpr:orig \
...
wait $pid
cat .out
convert "Ellora_Caves,_India,_The_Vishvakarma_Buddhist_Cave.jpg" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 -write mpr:orig \
...
pid=$!
convert "N-BR-39_Ashokan_Pillar_Vaishali_(13).jpg" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 -write mpr:orig \
...
wait $pid
cat .out
convert "Protest_against_Trident_II_Missile,_Cape_Canaveral_Florida,_1987_06.jpg" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 -write mpr:orig \
...
pid=$!
convert "034_Buddha_Teaching_(39570552165).jpg" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 -write mpr:orig \
...
wait $pid
cat .out
convert "default.jpg" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 -write mpr:orig \
...
pid=$!
convert "Gango-ji_Buddhist_temple_in_Nara_in_the_early_morning_light_of_the_east_on_October_29,_2018.jpg" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 -write mpr:orig \
...
wait $pid
cat .out
convert "waterfall.jpg" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 -write mpr:orig \
...
pid=$!
convert "Golden_Mount,_Bangkok,_Thailand_(4244516258).jpg" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 -write mpr:orig \
...
wait $pid
cat .out
convert "2259528661_7ffa43ed8b_o_d.jpg" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 -write mpr:orig \
...
pid=$!
convert "Buddhist_nuns_Yangon.jpg" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 -write mpr:orig \
...
wait $pid
cat .out
convert "default2.jpg" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 -write mpr:orig \
...
pid=$!
convert "SrA_Jette_Carr,_USAF_(5)_(14532088103).jpg" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 -write mpr:orig \
...
wait $pid
cat .out
convert "(Above)_sBed-byed_(Gopaka),_holding_a_book;_Wellcome_V0018272_(cropped).jpg" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 -write mpr:orig \
...
pid=$!
convert "High_Tap.jpg" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 -write mpr:orig \
...
wait $pid
cat .out
convert "Zhaya_Theingyi-Sagaing-Myanmar-02-gje.jpg" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 -write mpr:orig \
...
pid=$!
convert "Origami_(13777498043).jpg" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 -write mpr:orig \
...
wait $pid
cat .out
convert "Nanzen-ji,_a_Zen_Buddhist_temple,_and_its_surroundings,_Kyoto;_November_2016_(01).jpg" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 -write mpr:orig \
...
pid=$!
convert "Buddhist_monk_on_cellphone_(8064140438).jpg" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 -write mpr:orig \
...
wait $pid
cat .out
convert "gate.jpg" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 -write mpr:orig \
...
pid=$!
convert "Buddhist_prayer_flags.jpg" -verbose -strip -define webp:method=6 -define webp:pass=6 -define webp:target-psnr=49 -write mpr:orig \
